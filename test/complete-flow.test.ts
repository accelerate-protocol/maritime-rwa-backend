...
describe("V2 架构完整业务流程测试", function () {
    ...
    describe("10. 链下认购 Claim 操作测试", function () {
        ...
        it("应该在transfer后正确更新用户数据", async function () {
            ...
            // user1领取分红
            // console.log("user1Info.lastClaimDividend",user1Info.lastClaimDividend);
            // console.log("totalDividend",totalDividend);
            var delDidUser1 = totalDividend  - user1Info.lastClaimDividend;
            // console.log("delDid",delDid);
            var actualSharesUser1 = await token.balanceOf(user1.address);
            ...
            user2Info = await accumulatedYield.getUserInfo(user2.address);
            console.log("user2Info.accumulatedShares",user2Info.accumulatedShares);
            console.log("user2Info.lastClaimDividend",user2Info.lastClaimDividend);
            console.log("globalPool.totalDividend",globalPool.totalDividend);
            console.log("actualSharesUser2",actualSharesUser2);
