    ...
    AccessControlUpgradeable
{
    ...
    function dividend(uint256 dividendAmount) public {
        require(msg.sender==rbf, "Vault: only RBF can call");
        SafeERC20.safeTransferFrom(
            IERC20(assetToken),
            msg.sender,
            dividendTreasury,
    ...
    function _updateUserPool(address user) internal {
        ...
        uint256 deltaDiv =totalDividend - userInfo.lastClaimDividend;
        ...
        userInfo.lastClaimDividend = totalDividend;
