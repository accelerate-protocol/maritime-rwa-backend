...
//   console.log("totalSupplyRaw",totalSupplyRaw)
//   const totalSupply = Number(totalSupplyRaw / BigInt(1e6));
...
//     var balance = await usdt.balanceOf(vaultInvestors[i].address);
//     tx=await execute(
//       "MockUSDT",
...
//     balance = await usdt.balanceOf(vaultInvestors[i].address);
//     console.log("投资后持有代币数量:",balance.toString())
//   }
...
//       console.log("派息前投资用户" + j + "-USDT余额:", investorUsdt.toString());
//     }
