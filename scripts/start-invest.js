...
async function main() {
  ...
  if (network === "hardhat" || network === "localhost") {
    // 本地网络使用固定的项目名称
    projectName = "Project_1756263179368";
    console.log("使用固定项目名称:", projectName);
  } else {
    // 测试网使用环境变量配置
    projectName = process.env.PROJECT_NAME || "Project_1756263179368";
    if (process.env.PROJECT_NAME) {
      console.log("使用环境变量配置的项目名称:", projectName);
    } else {
      console.log("使用默认项目名称:", projectName);
    }
  }
